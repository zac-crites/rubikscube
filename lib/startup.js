...
define("scrambler", ["require", "exports", "turnable"], function (require, exports, turnable_4) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    var Scrambler = /** @class */ (function () {
        ...
        Scrambler.prototype.scramble = function (cube, turns) {
            var faceMoves = [
                [turnable_4.Turn.U, turnable_4.Turn.Ui, turnable_4.Turn.U2],
                [turnable_4.Turn.D, turnable_4.Turn.Di, turnable_4.Turn.D2],
                [turnable_4.Turn.L, turnable_4.Turn.Li, turnable_4.Turn.L2],
                [turnable_4.Turn.R, turnable_4.Turn.Ri, turnable_4.Turn.R2],
                [turnable_4.Turn.F, turnable_4.Turn.Fi, turnable_4.Turn.F2],
                [turnable_4.Turn.B, turnable_4.Turn.Bi, turnable_4.Turn.B2],
            ];
...
define("standardControlScheme", ["require", "exports", "turnable"], function (require, exports, turnable_5) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    var StandardControlScheme = /** @class */ (function () {
        ...
        StandardControlScheme.prototype.register = function (hotkeys, target, camera) {
            var targetBindings = [
                ["q", "Z'", turnable_5.Turn.Zi],
                ["w", "B", turnable_5.Turn.B],
                ["e", "L'", turnable_5.Turn.Li],
                ["r", "I'", turnable_5.Turn.Ii],
                ["y", "X", turnable_5.Turn.X],
                ["u", "r", turnable_5.Turn.r],
                ["i", "R", turnable_5.Turn.R],
                ["o", "B'", turnable_5.Turn.Bi],
                ["p", "Z", turnable_5.Turn.Z],
                ["a", "Y'", turnable_5.Turn.Yi],
                ["s", "D", turnable_5.Turn.D],
                ["d", "L", turnable_5.Turn.L],
                ["f", "U'", turnable_5.Turn.Ui],
                ["g", "F'", turnable_5.Turn.Fi],
                ["h", "F", turnable_5.Turn.F],
                ["j", "U", turnable_5.Turn.U],
                ["k", "R'", turnable_5.Turn.Ri],
                ["l", "D'", turnable_5.Turn.Di],
                [";", "Y", turnable_5.Turn.Y],
                ["v", "I", turnable_5.Turn.I],
                ["n", "X'", turnable_5.Turn.Xi],
                ["m", "r'", turnable_5.Turn.ri],
            ];
            if (camera) {
...
define("states/countdownState", ["require", "exports", "standardControlScheme", "turnable"], function (require, exports, standardControlScheme_1, turnable_6) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    ...
    var SafeCheckWrapper = /** @class */ (function (_super) {
        ...
        function SafeCheckWrapper(target, callback) {
            ...
            _this.safeTurns = [turnable_6.Turn.X, turnable_6.Turn.Xi, turnable_6.Turn.Y, turnable_6.Turn.Yi, turnable_6.Turn.Z, turnable_6.Turn.Zi];
